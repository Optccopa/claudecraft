...
constexpr std::array<BlockInfo, static_cast<std::size_t>(BlockType::Count)> kBlocks{{
    {0, 0, 0, 0, false, false, false},   // Air
    {0, 0, 0, 0, true, true, true},      // Stone
    {1, 1, 1, 0, true, true, true},      // Dirt
    {2, 3, 1, 0, true, true, true},      // Grass
    {4, 4, 4, 0, true, true, true},      // Sand
    {5, 5, 5, 0, false, false, false},   // Water
    {7, 6, 7, 0, true, true, true},      // Wood
    {8, 8, 8, 0, true, true, true},      // Leaves
    {9, 9, 9, 0, true, true, true},      // Plank
    {10, 10, 10, 0, true, true, true},   // Snow
    {11, 11, 11, 0, true, true, false},  // Bedrock
    {12, 12, 12, 0, true, true, true},   // CoalOre
    {13, 13, 13, 0, true, true, true},   // IronOre
    {14, 14, 14, 0, true, true, true},   // GoldOre
    {15, 15, 15, 0, true, true, true},   // DiamondOre
    {16, 16, 16, 15, true, true, true},  // Glowstone
}};
